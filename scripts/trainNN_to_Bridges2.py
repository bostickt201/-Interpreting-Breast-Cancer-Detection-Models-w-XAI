...
# save 12-layer nn
model = create_larger()
model.save('/Users/taylor/Desktop/DS340W/term_project/models/12layerNN')

##############################################################################

# Reconstruct the model and evaluate on test data:
reconstructed_model = models.load_model('/Users/taylor/Desktop/DS340W/term_project/models/12layerNN')
...
estimators = []
estimators.append(('standardize', StandardScaler()))
estimators.append(('mlp', KerasClassifier(model=reconstructed_model, epochs=100, batch_size=32, verbose=0)))
